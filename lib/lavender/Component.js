class Component {
    ...
    resolve(context, thisArg = {}) {
        ...
        try {
            ...
            console.log(`lavender > Component failed with error: ${e}`)
            console.log(e)

            let data = this.fallbackHydrator != null ? this.fallbackHydrator(e, context) : {}

            final = this.fallbackSyntaxTree.walk({}, context, Object.assign(data, { error: e }), this.componentStore)
        }
        return final
    }

    constructor(templates, hydrators, app = null) {
        this.app = app
        ...
        if (typeof this.fallbackTemplate == "string") this.fallbackSyntaxTree = new AST(this.fallbackTemplate)
    }
}
...
class AST {
    ...
    */
    ...
    getSymbol(symbol, data, context, important = false) {
        ...
        if (symbolMatch == null) throw `Syntax error`
        ...
        while (stack.length > 0) {
            ...
            switch (currentStep.constructor.name) {
                ...
                case "RenderStep":
                    ...
                    if (currentStep.symbol) componentThisArg = this.getSymbol(currentStep.symbol, data, context, true)
