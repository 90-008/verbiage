...
class Component {
    ...
    resolve(context, thisArg = {}) {
        ...
        try {
            ...
            final = this.syntaxTree.walk(data, context, thisArg, this.componentStore)
            errored = false
        } catch (e) {
                ...
                if (tokenCount == 0) {
                    ...
                    switch (token) {
                        ...
                        case "slot":
                            ...
                            break
                        case "put":
                            let putS = new PutStep(this.component, firstBrace).apply({
                                symbol: tokenParts[1]
                            })
        ...
        while (stack.length > 0) {
            ...
            switch (currentStep.constructor.name) {
                ...
                case "SlotStep":
                    ...
                    break
                case "PutStep":
                    final += Sanitizer.escape(this.getSymbol(currentStep.symbol, data, context, currentStep))
                    break
                default:
