class RouteTree {
    ...
    dig(parts, shouldCreate) {
        ...
        while (found == null) {
            ...
            let candidate = where.children.get(parts[index])
                ...
                if (shouldCreate) {
                    ...
                    */
                    ...
                    /*
                        ...
                        generic params.
                    */
                    candidate = where.children.get("*") || where.children.get("+")

                    if (candidate == null) break

                    if (candidate == where.children.get("+")) {
                        args[index] = decodeURIComponent(parts.slice(index).join("/"))
                        found = candidate
                        break
                    } else {
...
class RouteLeaf {
    ...
    add(name) {
        if (!this.children.get(name)) this.children.set(name, new RouteLeaf())
