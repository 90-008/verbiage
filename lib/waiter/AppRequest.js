...
class Header {
    ...
    */
    ...
    constructor(head) {
        /*
            Some-Header: value; attribute="asdf" -> { name: "Some-Header", content: "value; attribute..." }
            value; attribute="asdf" -> { name: null, content: "value; attribute..." }
        */
            ...
            switch (state) {
                ...
                case MultipartParseState.WriteBody:
                    if (this.bytesStartsWith(currentLine, boundaryBytes)) { // if body chunk starts with our boundary
                        ...
                        currentField.body = Buffer.from(currentField.body.slice(0, currentField.body.length - 2)) // cut trailing newline
